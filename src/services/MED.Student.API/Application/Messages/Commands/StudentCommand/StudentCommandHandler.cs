...
namespace MED.Student.API.Application.Messages.Commands.StudentCommand
{
        ...
        IRequestHandler<UpdateAdressStudentCommand, BaseResult>
    {
        ...
        public StudentCommandHandler(IStudentRepository studentRepository, IMessageBusHandler messageBusHandler)
        {
        ...
        public async Task<BaseResult> Handle(AddStudentCommand command, CancellationToken cancellationToken)
        {
            ...
            foreach (var item in guardians)
            {
                ...
                await _messageBusHandler.SendMessage("new-user", user);
            }

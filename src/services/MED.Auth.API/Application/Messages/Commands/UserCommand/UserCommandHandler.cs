...
namespace MED.Auth.API.Application.Messages.Commands.UserCommand
{
        ...
        IRequestHandler<SignInUserCommand, BaseResult>
    {
        ...
        public UserCommandHandler(IUserRepository userRepository, ITokenRepository tokenRepository, IConfiguration configuration)
        {
